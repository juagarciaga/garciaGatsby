...
export const Menu = ({ siteTitle }) => {
  ...
  return (    
    <Navbar bg="light" expand='lg'>  
      <Container>
        <Link className='navbar-brand d-lg-none' to="/">{siteTitle}</Link>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="ml-auto">
            ...
            <CustomLink 
              className={classNames({ active: TeachingActive }, 'mx-lg-4 mb-lg-0 h5 font-weight-bold nav-link' )}
              to="/Teaching">
                Teaching 
                <BorderHover/>
            </CustomLink>
            <CustomLink 
              className={classNames({ active: ResearchActive }, 'mx-lg-4 mb-lg-0 h5 font-weight-bold nav-link' )}
              to="/Research">
                Research 
                <BorderHover/>
            </CustomLink>
            <CustomLink 
              className={classNames({ active: CVActive }, 'mx-lg-4 mb-lg-0 h5 font-weight-bold nav-link' )}
              to="/CV">
                CV 
                <BorderHover/>
            </CustomLink>
            <CustomLink 
              className={classNames({ active: OtherActive }, 'mx-lg-4 mb-lg-0 h5 font-weight-bold nav-link' )}
              to="/Other">
                Other 
                <BorderHover/>
            </CustomLink>
